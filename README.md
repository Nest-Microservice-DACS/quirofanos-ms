...
## Microservicio de Gestión de Quirófanos

Este módulo es un microservicio desarrollado con NestJS que utiliza comunicación TCP para la gestión de los quirófanos del hospital, permitiendo operaciones como alta, consulta, actualización y baja de quirófanos.
...
## Descripción
Este microservicio administra y expone operaciones para la gestión de los distintos quirófanos del hospital mediante comunicación TCP, permitiendo su integración con otros módulos del sistema y facilitando el acceso seguro a la información de quirófanos.
...
- `findAllOperatingRooms`: Obtiene la lista de quirófanos
- `findOperatingRoomById`: Obtiene un quirófano por su ID
- `createOperatingRoom`: Crea un nuevo quirófano
- `updateOperatingRoom`: Actualiza un quirófano existente
- `deleteOperatingRoom`: Elimina un quirófano
